...
using DexLK.Authentication.Models;
using System.Security.Cryptography;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using System.ComponentModel.DataAnnotations;

namespace DexLK.Authentication.Services
{
    ...
    public class UserService : IUserService
    {
        ...
        private  DexLKAuthenticationDbContext _webApiDbcontext;

        public UserService(DexLKAuthenticationDbContext webApiDbcontext,  IOptions<AppSettings> appSettings)
        ...
        {
            var user = _webApiDbcontext.User.FirstOrDefault(x => x.Username == model.Username && x.Password == model.Password);
        ...
        private string GenerateJwtToken(User user)
        {
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Expires = DateTime.UtcNow.AddMinutes(_appSettings.ExpireMinutes),
